...
export const DestinationCard = () => {
  return (
    <div className="container mx-auto px-2 py-5 flex justify-center" style={{ width: "100%" }}>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-20 max-w-screen-xl px-10 w-[85%]">
        ...
        {cardsDestinationData.map((card, index) => (
          <div key={index} className="col-span-1 flex justify-center">
            <div className="rounded-2xl shadow-2xl shadow-gray-500 w-80 sm:w-full mx-2 p-4 transform transition-transform hover:scale-105 overflow-hidden">
              ...
              <div className="p-3 flex flex-col justify-between h-full">
                <div className="text-gray-500">
                  ...
                  <div className="mt-2 flex items-center">
                    ...
                    <span className="font-semibold text-xl" style={{ fontFamily: 'Poppins' }}>{card.days} days travel</span>
                  </div>
                </div>
              </div>
            </div>
