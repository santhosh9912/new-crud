          ...
          <div class="container flex flex-col flex-wrap px-5 py-7 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap ">
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
              <a class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                <h2 className="font-bold text-lg text-blue-950">WedTech</h2>
              </a>
            ...
            <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
              <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 class="mb-3 text-sm font-extrabold tracking-widest text-blue-950 uppercase title-font">
                  Company
                </h2>
                <nav class="mb-10 list-none">
                  <li class="mt-3">
                    <a class="text-gray-900 cursor-pointer hover:text-gray-500">
                      About
                    </a>
                  </li>
                  <li class="mt-3">
              ...
              <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                <h2 class="mb-3 text-sm font-extrabold text-blue-950 tracking-widest uppercase title-font">
                  Contact
                </h2>
                <nav class="mb-10 list-none">
                  <li class="mt-3">
              ...
              <div class="w-full px-4 lg:w-1/4 md:w-1/2">
               ...
               <div className="flex items-center justify-center flex-col"> {/* Center content vertically and horizontally */}
                ...
                <p className="mt-2">Download on Play Store</p>
              </div>
              </div>
            </div>
          </div>
