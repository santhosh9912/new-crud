...
export const TwoColumnGrid = () => {
  return (
    <div
      ...
      style={{ width: "100%", height: "auto" }} // Adjust height to "auto"
    >
      <div className="flex flex-col sm:flex-row justify-between gap-4 w-[80%]"> {/* Added responsive classes */}
        ...
        {/* Second column */}
        <div className="sm:w-1/2 pl-4"> {/* Added responsive width */}
          <div
            className="w-full sm:w-370 h-300 border rounded-xl shadow-sky-800 shadow-2xl overflow-hidden p-4" // Added p-4 for padding
          >
            <img
              src={Rectangle}
              className="w-full h-200 object-cover pb-8"
              alt=""
            />
